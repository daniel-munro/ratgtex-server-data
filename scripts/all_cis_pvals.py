...
Inputs:
    {indir}/{version}/{tissue}/{tissue}.expression.cis_qtl_all_pvals.txt.gz
...
infile = args.indir / args.version / args.tissue / f'{args.tissue}.expression.cis_qtl_all_pvals.tsv.gz'
...
with gzip.open(infile, 'rt') as f:
    with zipfile.ZipFile(outfile, 'w', zipfile.ZIP_DEFLATED) as out:
        ...
        for line in f:
            ...
            if gene != last_gene:
                assert gene not in seen, gene # Entries for a gene should be consecutive
                seen.add(gene)
